    ...
    >
      <div className="legal__prose">
        ...
        <p>
          ...
          binding contract to use this site or purchase our products. By
          ordering, you represent that you meet these requirements and that you
          are acquiring products for lawful research purposes only.
        </p>

        <h2>3. Research use only</h2>
        <p>
          All products sold by Renew are intended strictly for laboratory
          research use. They are not for human or animal consumption. Full
          restrictions are set out in our{" "}
          <Link to="/research-use-terms">Research Use Only Terms</Link>, which
        ...
        <p>
          ...
          refuse, cancel, or limit any order at our discretion, including where
          we suspect misuse or a violation of these terms. Prices, promotions,
          and product descriptions may change at any time without notice, and we
        ...
        <p>
          ...
          <Link to="/refund-policy">Refund &amp; Returns Policy</Link>. In
          short, we accept returns and refunds only for products that are unused
          and unopened.
        </p>
        ...
        <p>
          ...
          fullest extent permitted by law, Renew disclaims all warranties,
        ...
        <p>
          To the fullest extent permitted by law, Renew shall not be liable for
          any indirect, incidental, special, or consequential damages, or for
          any loss arising from the handling, storage, or misuse of our
          products. Our total liability for any claim will not exceed the amount
